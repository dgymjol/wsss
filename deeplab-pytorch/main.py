...
from libs.models import DeepLabV2_ResNet101
...
def train(config_path, cuda):
    ...
    assert (
        CONFIG.MODEL.NAME == "DeepLabV2_ResNet101"
    ), 'Currently support only "DeepLabV2_ResNet101"'

    # Model setup
    model = DeepLabV2_ResNet101(n_classes=CONFIG.DATASET.N_CLASSES)
